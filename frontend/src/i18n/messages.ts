...
export const messages: Record<Lang, Dict> = {
  en: {
    ...
    accountTypeCommandGlobal: 'Command Code (Go plan)',
    accountTypeCommandGlobalHint: 'Command Code via a pasted user_… key. Speaks /alpha/generate so the $1 Go plan works without Pro API access.',
  ...
  zh: {
    ...
    accountTypeCommandGlobal: 'Command Code（Go 套餐）',
    accountTypeCommandGlobalHint: '粘贴 user_… 密钥接入。走 /alpha/generate，无需 Pro API 即可使用 $1 Go 套餐。',
